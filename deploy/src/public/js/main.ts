...
document.addEventListener('DOMContentLoaded', () => {
    const startupForm = document.getElementById('startupForm') as HTMLFormElement;
    const addRoleBtn = document.getElementById('addRoleBtn') as HTMLButtonElement;
    const rolesContainer = document.getElementById('rolesContainer') as HTMLDivElement;
    const startupListContainer = document.getElementById('startupListContainer') as HTMLDivElement;
    const startupList = document.getElementById('startupList') as HTMLDivElement;
    ...
    async function handleFormSubmit(event: Event) {
        ...
        const roleInputs = document.querySelectorAll('.role-input') as NodeListOf<HTMLInputElement>;
    ...
    function setupRemoveRoleListeners() {
        const removeButtons = document.querySelectorAll('.remove-role') as NodeListOf<HTMLButtonElement>;
    ...
    async function fetchStartups() {
        try {
            ...
            const startups = await response.json() as Startup[];
    ...
    function renderStartups(startups: Startup[]) {
    ...
    function renderRoleBadges(roles: Role[]): string {
