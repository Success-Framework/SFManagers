...
function isStartupMember(userId, startupId) {
...
function initializeTaskStatuses(startupId) {
    return __awaiter(this, void 0, void 0, function* () {
        const existingStatuses = yield prisma.taskStatus.findMany({
            where: { startupId }
        });
        if (existingStatuses.length === 0) {
            const defaultStatuses = ['To Do', 'In Progress', 'Done'];
            for (const status of defaultStatuses) {
                yield prisma.taskStatus.create({
                    data: {
                        name: status,
                        startup: {
...
router.get('/statuses/:startupId', auth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { startupId } = req.params;
        const userId = req.user.id;
        // Check if user is a member of the startup
        const isMember = yield isStartupMember(userId, startupId);
        if (!isMember) {
            return res.status(403).json({ msg: 'Not authorized to access this startup' });
        }
        // Initialize statuses if they don't exist
        yield initializeTaskStatuses(startupId);
        // Get all statuses for the startup
        const statuses = yield prisma.taskStatus.findMany({
            where: { startupId }
        });
        res.json(statuses);
    }
...
router.get('/startup/:startupId', auth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const transformedTasks = tasks.map(task => (Object.assign(Object.assign({}, task), { assignees: task.assignees.map(assignee => assignee.user) })));
...
router.post('/', auth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const transformedTask = Object.assign(Object.assign({}, task), { assignees: task.assignees.map(assignee => assignee.user) });
...
router.patch('/:taskId/status', auth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Check if user is a member of the startup
        const isMember = yield isStartupMember(userId, task.startupId);
        if (!isMember) {
            return res.status(403).json({ msg: 'Not authorized to update this task' });
        }
        // Get the new status
        const newStatus = yield prisma.taskStatus.findUnique({
            where: { id: statusId }
        });
        if (!newStatus) {
        ...
        // Transform the response
        const transformedTask = Object.assign(Object.assign({}, updatedTask), { assignees: updatedTask.assignees.map(assignee => assignee.user) });
        res.json(transformedTask);
    }
    catch (err) {
        console.error(err.message);
...
// Update a task
router.put('/:taskId', auth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { taskId } = req.params;
        ...
        if (assigneeIds !== undefined) {
            ...
            yield prisma.taskAssignee.deleteMany({
                where: { taskId }
            });
            // Then add the new assignees if any are provided
            if (assigneeIds && assigneeIds.length > 0) {
                yield Promise.all(assigneeIds.map(assigneeId => prisma.taskAssignee.create({
                    data: {
...
// Delete a task
router.delete('/:taskId', auth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { taskId } = req.params;
        const userId = req.user.id;
        // Get the task to verify ownership
...
router.get('/user', auth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const userId = req.user.id;
...
router.post('/:taskId/timer/start', auth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { taskId } = req.params;
        const userId = req.user.id;
        // Find the task
...
router.post('/:taskId/timer/pause', auth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { taskId } = req.params;
        const userId = req.user.id;
        const { note } = req.body;
        ...
        const timeTrackingLog = yield prisma.timeTrackingLog.create({
            data: {
                task: { connect: { id: taskId } },
...
router.get('/:taskId/time-logs', auth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { taskId } = req.params;
        const userId = req.user.id;
        // Find the task
        ...
        // Get time logs
        const timeLogs = yield prisma.timeTrackingLog.findMany({
            where: { taskId },
            include: {
                user: {
                    select: {
...
router.post('/:taskId/timer/stop', auth, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { taskId } = req.params;
        const userId = req.user.id;
        // Get the task
        ...
        const timeLog = yield prisma.timeTrackingLog.create({
            data: {
                taskId,
                userId,
                startTime: task.timerStartedAt,
