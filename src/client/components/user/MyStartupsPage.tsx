...
const MyStartupsPage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Add event listener for refreshing joined startups
    const handleRefreshJoinedStartups = () => {
      fetchData();
    };
    window.addEventListener('refreshJoinedStartups', handleRefreshJoinedStartups);

    // Cleanup event listener on unmount
    return () => {
      window.removeEventListener('refreshJoinedStartups', handleRefreshJoinedStartups);
    };
  }, [token, navigate]);
