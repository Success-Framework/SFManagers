...
router.get('/:linkId', authMiddleware, async (req, res) => {
  try {
    ...
    // Skip authorization checks - all users have access
    console.log('Access granted: authorization checks bypassed');
...
const validateLinkAccess = async (userId, startupId) => {
  // Return true to allow all users to access any link's analytics data
  return true;
